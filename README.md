...
- ✦ **Встроенный 7-Zip** — никаких внешних зависимостей
...
Перед сборкой положи `7z.exe` и `7z.dll` в корень проекта — они вкомпиливаются через `include_bytes!`.
...
| `encoding_rs` | декодирование вывода 7-Zip (Windows CP866) |
